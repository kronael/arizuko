...
`7/1` non-goals apply. Additionally, for all adapters:

- No message browsing — messages live in routd (`7/3`); the adapter
...
- No outbound queue control (routd-side, `7/3`).
