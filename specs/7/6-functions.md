---
status: draft
depends: specs/5/W-webhook-routes.md, specs/5/I-tool-call-logging.md, specs/6/F-audit-stream.md, specs/7/1-mcp-rest-unification.md, specs/7/3-git-as-truth.md, specs/7/5-yaml-manifests.md
---
...
- [`../7/1-mcp-rest-unification.md`](1-mcp-rest-unification.md) — one
