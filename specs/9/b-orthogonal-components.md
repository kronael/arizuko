...
proxy serve`. Stateless about what's behind the source IPs. See
  [`specs/7/9-crackbox-standalone.md`](../7/9-crackbox-standalone.md).
- **`crackbox/pkg/host/`** — Go library for KVM/qemu sandbox
  ...
  [`specs/7/12-crackbox-sandboxing.md`](../7/12-crackbox-sandboxing.md).
...
[`specs/7/10-crackbox-arizuko.md`](../7/10-crackbox-arizuko.md)
