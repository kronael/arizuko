...
2. **The platform thesis** (`specs/9/index.md`) — "agent is data."
...
state-changing call ([`../8/F-audit-stream.md`](../8/F-audit-stream.md),
...
([`../8/F`](../8/F-audit-stream.md)) is its own crash-safe substrate
...
ciphertext. Per `specs/9/2-data-model.md`.
...
5. **Phase 3c (postpone)** — entities where the git shape is
   ...
   - `chats` — split needed (see `specs/9/2-data-model.md`); keep
