...
- Cross-link to `specs/12/A-orthogonal-components.md` is mentioned but
...
- `specs/12/A-orthogonal-components.md` — sibling discipline crackbox
...
- **§ Cross-link to specs/12/A-orthogonal-components.md.** Adopt the
