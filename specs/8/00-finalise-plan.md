...
- Cross-link to `specs/6/16-daemon-standalone-matrix.md` is mentioned but
...
- `specs/6/16-daemon-standalone-matrix.md` — sibling discipline crackbox
...
- **§ Cross-link to specs/6/16-daemon-standalone-matrix.md.** Adopt the
...
The four open questions at `specs/8/index.md` L46-52 land as follows:
