...
- Cross-link to `specs/6/7-orthogonal-components.md` is mentioned but
...
- `specs/6/7-orthogonal-components.md` — sibling discipline crackbox
...
- **§ Cross-link to specs/6/7-orthogonal-components.md.** Adopt the
