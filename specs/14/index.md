...
| ~~a-crackbox-sandboxing.md~~                                 | superseded | KVM/qemu sandboxing → [specs/11/12-crackbox-sandboxing.md](../11/12-crackbox-sandboxing.md) |
| [g-pay-sh.md](g-pay-sh.md)                                   | draft      | pay.sh micropayment layer — agent-native paid API access via HTTP 402 + Solana wallet       |
| ~~h-surrogate-oauth.md~~                                     | superseded | Surrogate OAuth → [specs/11/14-surrogate-oauth.md](../11/14-surrogate-oauth.md)             |
