...
**Phase 8** delivers the operationally-minimal pivot: data-model tier
...
active work (`5/45` mechanism + `5/44` rollout); the remaining phase-8
actions are the data model and git-as-truth.

Together: phases 5 + 7 give **enterprise-ready** (capabilities +
trust); phase 8 gives **operationally minimal** (one storage
...
| [8/](8/)   | platform program — data model, git-as-truth (MCP+REST unification → 5/44·5/45) | drafting |
