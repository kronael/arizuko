...
| [13-b-ant-standalone.md](13-b-ant-standalone.md)       | Go standalone-ant rewrite. The standalone ant already exists in TS (`ant/ant` launcher + `arizuko-ant` image); this specced an abandoned Go reimpl. Superseded by `6/4` (scoped reimplement-in-Go) + `6/5` (ant = interface/template, runner = crackbox/dockbox). |
