...
- `container/runner.go` mounts `cfg.WebDir` at `/workspace/web`.
- `vited` mounts `DATA_DIR/web:/web` and serves from `/web/` (WEB_ROOT default).
  Agent writes `/workspace/web/<app>/index.html` → vite serves at `/<app>/`.
