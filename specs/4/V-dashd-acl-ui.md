...
(`specs/4/9-acl-unified.md:9-18`); this UI is the operator-facing
...
id (`specs/4/9-acl-unified.md:58, 70`).
...
matching `specs/4/9-acl-unified.md:284-286` lean) rejects obviously
...
(`specs/4/9-acl-unified.md:157-159`) before insert.
...
(`specs/4/9-acl-unified.md:176-177`). Re-uses the lookup; does not
reimplement.
...
3. **Tier-default fallback** — for `folder:` principals, output of
   ...
   (`specs/4/9-acl-unified.md:184-187`); shown only when no
...
`RenderACL` returns (`specs/4/9-acl-unified.md:234-239`). When
...
`arizuko create` (`specs/4/9-acl-unified.md:266-280`).
