...
- [l-slakd.md](l-slakd.md) — shipped — slakd: Slack via Events API webhook + bot token (v1)
- [m-forward-playbook.md](m-forward-playbook.md) — shipped — operator playbook: when/how the bot should forward across chats and platforms
