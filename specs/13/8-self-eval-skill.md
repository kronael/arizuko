---
status: superseded
superseded-by: specs/10/1-self-eval-haiku.md
source: hermes-agent peel (2026-04-11)
---

# Self-eval via sub-query at container exit

> **Superseded by [specs/10/1-self-eval-haiku.md](../10/1-self-eval-haiku.md)
...
([../12/8-skill-guard.md](../12/8-skill-guard.md)) composes naturally
