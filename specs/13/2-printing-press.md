...
Once [5/17-openapi-mcp.md](../5/17-openapi-mcp.md) lands and each
...
4. **Layer 4** — `pp-arizuko` once OpenAPI specs land per
   [5/17-openapi-mcp.md](../5/17-openapi-mcp.md). Phase-coupled
...
- `specs/5/17-openapi-mcp.md` — OpenAPI exposure prerequisite for
  Layer 4.
