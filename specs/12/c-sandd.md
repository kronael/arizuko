...
> ownership and imports [`crackbox/pkg/host/`](../12/12-crackbox-sandboxing.md)
...
library](../12/12-crackbox-sandboxing.md)) would compound the privilege surface.
...
- One pluggable Backend interface with two implementations:
  ...
  2. **Crackbox backend** — KVM/qemu via the [crackbox library](../12/12-crackbox-sandboxing.md);
...
- Crackbox backend (lands when [6/12-crackbox-sandboxing.md](../12/12-crackbox-sandboxing.md) ships)
