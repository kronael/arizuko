...
| ~~a-crackbox-sandboxing.md~~                                 | moved     | KVM/qemu sandboxing → [specs/9/12-crackbox-sandboxing.md](../9/12-crackbox-sandboxing.md) |
| [g-pay-sh.md](g-pay-sh.md)                                   | planned   | pay.sh micropayment layer — agent-native paid API access via HTTP 402 + Solana wallet     |
| [h-surrogate-oauth.md](h-surrogate-oauth.md)                 | deferred  | Third-party OAuth tokens (Jira/GitHub/Linear/…) for the bot to use on user's behalf       |
