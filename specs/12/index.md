...
| ~~a-crackbox-sandboxing.md~~                                 | superseded | KVM/qemu sandboxing → [specs/9/12-crackbox-sandboxing.md](../9/12-crackbox-sandboxing.md) |
| [g-pay-sh.md](g-pay-sh.md)                                   | draft      | pay.sh micropayment layer — agent-native paid API access via HTTP 402 + Solana wallet     |
| ~~h-surrogate-oauth.md~~                                     | superseded | Surrogate OAuth → [specs/9/14-surrogate-oauth.md](../9/14-surrogate-oauth.md)             |
