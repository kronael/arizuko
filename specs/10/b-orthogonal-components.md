...
under `specs/10/`. This file is the pattern, not the plans.
...
proxy serve`. Stateless about what's behind the source IPs. See
  [`specs/10/9-crackbox-standalone.md`](9-crackbox-standalone.md).
- **`crackbox/pkg/host/`** — Go library for KVM/qemu sandbox
  ...
  [`specs/10/12-crackbox-sandboxing.md`](12-crackbox-sandboxing.md).
...
[`specs/10/10-crackbox-arizuko.md`](10-crackbox-arizuko.md)
