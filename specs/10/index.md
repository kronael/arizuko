...
| [18-daemon-dashboards.md](18-daemon-dashboards.md) | superseded | Each daemon owns its own `/dash/`; dashd becomes the central index/hub. Superseded by `6/1-cockpit-index`. |
