...
- Cross-link to `specs/11/b-orthogonal-components.md` is mentioned but
...
- `specs/11/b-orthogonal-components.md` — sibling discipline crackbox
...
- **§ Cross-link to specs/11/b-orthogonal-components.md.** Adopt the
