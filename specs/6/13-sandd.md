...
> ownership and imports [`crackbox/pkg/host/`](9-crackbox-sandboxing.md)
...
library](9-crackbox-sandboxing.md)) would compound the privilege surface.
...
- One pluggable Backend interface with two implementations:
  ...
  2. **Crackbox backend** — KVM/qemu via the [crackbox library](9-crackbox-sandboxing.md);
...
- Crackbox backend (lands when [9-crackbox-sandboxing.md](9-crackbox-sandboxing.md) ships)
