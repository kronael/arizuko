...
| [F-audit-stream.md](F-audit-stream.md)                   | spec    | Append-only SIEM-export stream: three JSONL files (system/messages/web). Absorbs `cli_audit` (v0.42.0) and `secret_use_log` (spec Y M1).                                                                                               |
