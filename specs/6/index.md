...
| [5-components-toolbox.md](5-components-toolbox.md)                   | draft   | arizuko as a toolbox: which components are usable separately (measured by import coupling), how to present them — crackbox + obs ship now, resreg → `mcpfw`; `servekit` web/service stack (concept) + rebrand-angle note |
