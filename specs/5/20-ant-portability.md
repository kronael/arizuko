...
Sibling to [b-ant-standalone.md](../13/b-ant-standalone.md) (folder
shape) and [c-ant-mcp-runtime.md](../13/c-ant-mcp-runtime.md) (runtime
...
- [b-ant-standalone.md](../13/b-ant-standalone.md) — folder layout the
  pack format mirrors.
- [c-ant-mcp-runtime.md](../13/c-ant-mcp-runtime.md) — runtime that
  consumes the folder; unaffected by this spec.
- [d-ant-image-cutover.md](../13/d-ant-image-cutover.md) — bind-mount
  layout for `~/.claude` ties into `--include-sessions` here.
- [3-template-distillation.md](../13/3-template-distillation.md) —
  producer side of templates; this spec is the consumer side.
- [../11/14-plugins.md](../11/14-plugins.md) — MCP-tool plugin
