...
| Daemon     | Owns                                                                                                                                                                            | Serves                                                                                                                                                                                            |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **routd**  | groups, routes, messages, sessions, channels, web_routes, route_tokens, grants, acl/user_groups, secrets, network_rules, cost_caps (residual config + conversation tables)      | `/v1/groups`, `/v1/routes`, `/v1/messages`, `/v1/sessions`, `/v1/channels`, `/v1/web_routes`, `/v1/web_presence`, `/v1/route_tokens`, `/v1/grants`, `/v1/acl`, `/v1/secrets`, `/v1/network_rules` |
