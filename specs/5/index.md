...
## From specs/7 (unshipped)

- [3-agent-messaging.md](3-agent-messaging.md) — REDACTED links as agent inboxes
- [5-agent-media-awareness.md](5-agent-media-awareness.md) — media attachment format, agent instructions
- [6-evangelist.md](6-evangelist.md) — community engagement agent concept
- [27-detached-containers.md](27-detached-containers.md) — file-based output, restart reclaim, idle survival
