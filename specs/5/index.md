...
| Spec                                             | Status  | Hook                                                                                                                                                                                                                                                  |
| ------------------------------------------------ | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [32-acl-unified.md](32-acl-unified.md)           | partial | **Canonical ACL.** One row primitive, three principals, one `auth.Authorize`, deny-wins.                                                                                                                                                              |
...
| [10-web-access.md](10-web-access.md)             | partial | `/priv` is a grant decision, not a second ACL — `auth.MatchGroups` in proxyd after auth.                                                                                                                                                              |
...
| [7-proxyd-standalone.md](7-proxyd-standalone.md)         | partial | Config-driven authenticating reverse proxy. Enforcement point, not authority — authd signs.                                                                                                                                                               |
...
| [14-credentials.md](14-credentials.md)                     | partial   | The credential model: env-profile versus capability versus infra.                                                                                     |
