...
| [16-mcp-rest-unification.md](16-mcp-rest-unification.md) | partial | The adoption program for `5/17`. All seven agent-facing cold-tier resources ride it, and federation shipped (`5/I`'s three-daemon `audit`) — but one owner did not: the mount still restates `Name`, OpenAPI still hand-passes its advertised set (`F33`), and the four unguarded daemons (`F40`) plus proxyd's second `store.Open` remain. |
...
| Spec                                                       | Status    | Hook                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [18-onboarding-model.md](18-onboarding-model.md)           | partial   | **The location axis**: an unrouted JID acquires a `routes` row. Steps 1–7 ship (picker `d9e57288`, attribution `120d5461`, the pairing fold `5/31`); step 8's dead end does not — a caller with no world still cannot make one, and the decision is open (BUGS `F42`). |
...
| Spec                                                             | Status  | Hook                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [28-packages.md](28-packages.md)                                 | partial | **The package manager (canonical lifecycle)** — one package's install/upgrade/remove, built; the lock is keyed `(folder, name)`, `''` = instance-wide (`F30`, closed). Composition (a group blending an ordered LIST of products) is still DEFERRED: no `sync`/`update` verb, no `CLAUDE.md` marker convention, and payload kinds that miss the corpus. |
