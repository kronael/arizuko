...
| [16-mcp-rest-unification.md](16-mcp-rest-unification.md) | partial | The adoption program for `5/17`. All seven agent-facing cold-tier resources ride it. Shape single-sourcing done; federation's mount-narrowing (steps 6-7), proxyd's `sub.Scope` sign-off, and the four unguarded daemons (`F40`) remain.                  |
