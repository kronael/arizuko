...
| `proxyd`                                     | `auth`, `chanlib`, `core`, `store`, `tests/testutils`                       | 3 active + 1 comment (`proxyd/main.go:102, 442, 446, 450`) | 0       | 0       | 2 (3 Group)       | strip `folder` from route table, make config-driven (realised in `specs/5/35-proxyd-standalone.md` "Per-daemon route declarations") |
...
`specs/5/35-proxyd-standalone.md` "Per-daemon route declarations" for
