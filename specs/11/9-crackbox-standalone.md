...
> [crackbox component](../11/12-crackbox-sandboxing.md). The
...
| `crackbox/pkg/host/`     | Library for VM sandboxing (see [10/a](../11/12-crackbox-sandboxing.md)). |
...
- Secret handling (now spec [`7/Y`](../7/Y-secret-broker.md), tool-level
