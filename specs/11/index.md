...
| [19-agent-capability-eval.md](19-agent-capability-eval.md) | draft                | `agenteval` — black-box prober: ~20 real tasks certify the agent can self-modify, spawn+grant subagents, publish web, build chat apps reachable via REST+MCP. Grades side effects, not prose. Ships standalone (11/A).                                           |
