...
name: ideation
description: >
  Generate project ideas through creative constraints. USE when the user
  says "I want to build something", "give me a project idea", "I'm bored",
  "what should I make", "inspire me", or any "I have tools but no
  direction" variant. Works for code, art, hardware, writing, tools —
  anything makeable. NOT for executing an already-chosen plan.
user-invocable: true
---

<!-- CREDITS: adapted from NousResearch/hermes-agent skills/creative/
     creative-ideation (MIT, author SHL0MS). Constraint library unchanged;
     frontmatter normalized to arizuko conventions. -->
