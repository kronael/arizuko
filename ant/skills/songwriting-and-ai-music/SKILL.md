...
description: >
  Songwriting craft + AI music generation prompts (Suno focus),
  parody/adaptation, phonetic tricks for AI singers. USE for "write a
  song", "song lyrics", "music prompt", "suno prompt", "parody song",
  "adapt this song", "AI music". Tools and ideas, not rules — break any
  when the art calls for it. NOT for sending audio files (use send_file /
  send_voice).
user-invocable: true
---

<!-- CREDITS: adapted from NousResearch/hermes-agent
     skills/creative/songwriting-and-ai-music (MIT). Craft content
     unchanged; frontmatter normalized to arizuko conventions. -->
