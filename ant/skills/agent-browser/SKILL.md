...
name: agent-browser
description: >
  CDP-based Chromium browser automation. USE for "log into this site",
  "screenshot this page", "fill this form", JS-rendered SPA, auth flows,
  data extraction from dynamic pages. NOT for static curl-able pages
  (use acquire).
