...
4. **Closer**: Punchy one-liner + "back to kroning."
...
1. Read examples in `examples/` for voice calibration
2. Write hook -> 2-3 body tweets -> closer
3. Read aloud — if it sounds like a pitch deck, rewrite
